...
public class A_QSort {
    ...
    private void quiskSort(Segment[] array, int low, int high){
        ...
        while (i <= j)
        {
            while (array[i].start < mediana .start){
                i++;
            }
            while (array[j].start > mediana .start){
                j--;
            }
            if(i<=j)
            {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group673602/pelevanyuk/lesson05/dataA.txt");

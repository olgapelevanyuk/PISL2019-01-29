...
public  class User {
    ...
    private by.bsuir.userhibernate.entity.City livingCity;
    @XmlElement(required = true)
    ...
    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    private by.bsuir.userhibernate.entity.Citizenship citizenship;
    ...
    public by.bsuir.userhibernate.entity.City getLivingCity() {
        return livingCity;
    }

    @Enumerated(EnumType.STRING)
    public void setLivingCity(by.bsuir.userhibernate.entity.City livingCity) {
    ...
    @Enumerated(EnumType.STRING)
    public by.bsuir.userhibernate.entity.Citizenship getCitizenship() {
        return citizenship;
    }
    @Enumerated(EnumType.STRING)
    public void setCitizenship(by.bsuir.userhibernate.entity.Citizenship citizenship) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof by.bsuir.userhibernate.entity.User)) return false;

        by.bsuir.userhibernate.entity.User user = (by.bsuir.userhibernate.entity.User) o;
